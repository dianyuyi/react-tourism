...
(function (G) {
              ...
              for (
                g = c.charCodeAt(e),
                  ...
                  128 > g
                    ? d.push(g)
                    : 2048 > g
                    ? (d.push(192 | (g >>> 6)), d.push(128 | (g & 63)))
                    : 55296 > g || 57344 <= g
                    ? d.push(
                        224 | (g >>> 12),
                        128 | ((g >>> 6) & 63),
        ...
        c = function (b, a, c) {
          ...
          for (d = 0; d < b.byteLength; d += 1)
            (e = d + m),
              ...
              a.length <= k && a.push(0),
              (a[k] |= l[d] << (8 * (3 + (e % 4) * -1)));
          return { value: a, binLen: 8 * b.byteLength + c };
        };
        break;
      default:
  ...
  function u(d, b) {
    ...
    return (
      ((((d >>> 16) + (b >>> 16) + (c >>> 16)) & 65535) << 16) | (c & 65535)
    );
  }
  ...
  function z(d, b) {
    ...
    for (e = 0; 80 > e; e += 1)
      (c[e] =
        16 > e ? d[e] : n(c[e - 3] ^ c[e - 8] ^ c[e - 14] ^ c[e - 16], 1)),
        (k =
          20 > e
            ? y(n(h, 5), (a & f) ^ (~a & g), m, 1518500249, c[e])
            : 40 > e
            ? y(n(h, 5), a ^ f ^ g, m, 1859775393, c[e])
            : 60 > e
            ? y(n(h, 5), (a & f) ^ (a & g) ^ (f & g), m, 2400959708, c[e])
